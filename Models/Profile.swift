...
struct Profile: Identifiable, Codable {
    ...
    init(id: UUID, userId: UUID, username: String? = nil, name: String? = nil, profileImageUrl: String? = nil, createdAt: Date = Date(), updatedAt: Date = Date()) {
        self.id = id
        self.userId = userId
...
struct ProfileUpdate: Codable {
    ...
    init(username: String? = nil, name: String? = nil, profileImageUrl: String? = nil) {
        self.username = username
        self.name = name
        self.profileImageUrl = profileImageUrl
